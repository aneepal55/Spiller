      ...
      <section className="auth-shell">
        <div className="auth-copy">
          ...
          <div className="auth-benefits">
            <span><i>01</i> Generate scenes in under 60 seconds</span>
            <span><i>02</i> Test cameras, staging, and lighting</span>
            <span><i>03</i> Share a live link with your team</span>
          </div>
        </div>
        <form className="auth-form" action="/create">
          <div className="form-heading"><span>Create your account</span><small>Early access</small></div>
          ...
          <button className="button auth-submit" type="submit">Create account <span>→</span></button>
